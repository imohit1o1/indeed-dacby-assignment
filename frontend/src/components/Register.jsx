        ...
        <div className="bg-white w-full max-w-md rounded-2xl shadow-xl shadow-orange-100 border border-orange-100 overflow-hidden">
          <div className="p-8">
            <div className="mb-8 text-center">
              <h1 className="text-3xl font-black text-orange-950 mb-2">Create Account</h1>
              <p className="text-slate-500 font-medium">Join us to start bookmarking stories</p>
            </div>
          ...
          <div className="bg-orange-50/50 p-6 border-t border-orange-100 text-center">
            <p className="text-sm font-bold text-slate-600">
              ...
              <Link to="/login" className="text-orange-600 hover:text-orange-700 underline decoration-2 underline-offset-4">
                Login here
              </Link>
            </p>
          </div>
